# Plot a Interactive Candlestick Chart in a Browser
import requests
import json
import arrow
import pandas as pd
...
time_step = "h1"  # Specify the type of data you want: m1, h1, or d1
...
start_time = datetime_today - DELTA_OF_7_DAYS
